            ...
            slide: function (e, ui) {
                ...
                if(!!_options.markers[ui.value]) {
                    ...
                    if(_options.markers[ui.value].feature !== undefined) {
                        if(_options.markers[ui.value].feature.properties.startDateTime){
                            if(_options.markers[ui.value]) $('#slider-timestamp').html(_options.markers[ui.value].feature.properties.startDateTime.substr(0, 19));
                        }else {
